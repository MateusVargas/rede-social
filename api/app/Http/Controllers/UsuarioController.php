...
class UsuarioController extends Controller
{
    ...
    public function perfil(Request $request)
    {
	    ...
	    if (isset($data['imagem'])) {
	    	Validator::extend('base64image',function($attribute,$value,$parameters,$validato){
            ...
            if ($user->imagem) {
                ...
                if (file_exists($imgUser)) {
                    unlink($imgUser);//apaga o arquivo
                }
            }
            ...
            file_put_contents($urlImagem, $file);//escreve no arquivo
    ...
    public function amigo(Request $request)
    {
    	...
    	if ($amigo && ($user->id != $amigo->id)) {
    		$user->amigos()->toggle($amigo->id);//toggle anexa o ID com os já existentes
